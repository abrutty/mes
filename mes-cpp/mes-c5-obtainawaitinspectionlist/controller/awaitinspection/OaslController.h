...
#include "domain/query/OaslQuery.h"
#include "Macros.h"
...
public://定义接口
    ...
    // 定义获取待检任务列表接口处理
    ENDPOINT(API_M_GET, "/pending-inspection", getPendingInspectionTasks, QUERIES(QueryParams, queryParams), API_HANDLER_AUTH_PARAME) {
        // 解析查询参数为Query领域模型
